...
namespace AppShared.Controls
{
    ...
    public class SearchableListView : SfListView
    {
        ...
        public static readonly BindableProperty SearchTextProperty =
            BindableProperty.Create(nameof(SearchText), typeof(string), typeof(SearchableListView), null,
                BindingMode.Default, null, OnSearchTextChanged);
        ...
        private static void OnSearchTextChanged(BindableObject bindable, object oldValue, object newValue)
        {
            ...
            if (listView != null && newValue != null && listView.DataSource != null)
            {
                listView._searchText = (string) newValue;
