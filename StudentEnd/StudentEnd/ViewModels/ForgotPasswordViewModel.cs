...
namespace StudentEnd.ViewModels
{
    ...
    public class ForgotPasswordViewModel : AccountViewModel
    {
        ...
        private async void SendCodeClicked()
        {
            ...
            var response = await HttpClient.GetAsync($"mail/ResetPasswordMail/StudentEnd/{Email.Value}");
        ...
        private async void SubmitClicked()
        {
            ...
            var response = await HttpClient.PostAsJsonAsync("student/resetPassword", new
            {
